...
function main_player($id,$type="livestream"){
	if($type="livestream"){
	?>
...
<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="400"
	...
	<embed
		...
		allowscriptaccess="always" id="utv864871" name="utv_n_<?php echo $id; ?>"
...
<a href="http://www.ustream.tv/"
	...
	<?php 
		...
		?>
		<iframe frameborder="0" scrolling="no" id="chat_<?php echo $id; ?>" src="http://www.justin.tv/chat/embed?channel=<?php echo $id; ?>&default_chat=jtv&popout_chat=true#r=DxorRhU~&s=em" height="500" width="300"></iframe>
		<?php 
	}else{
	echo "Unsupport webstream";
	}
	?>
...
<!-- 
	...
	overflow: auto;
	height: 410px;"><?php
		foreach($stream_gid as $key => $id){
		echo main_player($id,$stream_type[$key]). "<br />";
		} ?>
