...
<table>
	<tr>
		<td>
		<form action="?build=trigger" method="POST" />line<input name="line" /><br />
		...
		<input type="submit" value="Add to rover program" /></form>
		</td>
		<td>
		<form action="?build=sub" method="POST" />subProgram ID<input
			name="ID" /><br />
...
The real
<img src="<?php echo $filename . "?random=".rand() . microtime(); ?>"
	usemap="#controlmap" />
<?php echo $controlmap; ?>
</body>
</html>
